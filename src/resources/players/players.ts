...
export interface PlayerStatsOptions extends BasePlayerStatsOptions {
  stats: Omit<
    NHLStatTypeName,
    NHLRankingsStatTypeName | NHLGoalsByGameSituationStatTypeName
  >;
}
...
export interface PlayerGoalsByGameSituationOptions
  extends BasePlayerStatsOptions {
...
function getPlayerStats(
  options: PlayerStatRankingsOptions
): Promise<NHLPlayerStatRankings[]>;
function getPlayerStats(
  options: PlayerGoalsByGameSituationOptions
): Promise<NHLPlayerGoalsByGameSituation[]>;

function getPlayerStats(
  options: AllPlayerStatOptions
): Promise<PlayerStatsReturnType> {
